...
function Login() {
  return (
    <AuthLayout>
      <div className="w-96 h-[40rem] bg-primary-950 rounded-2xl shadow-md shadow-slate-950  z-50 custom-gradient flex flex-col gap-6 p-4">
        <h1 className="text-2xl text-primary-500 font-extrabold">Time Flow</h1>
        <div className="flex justify-center">
          <img src="../../../public/clipboard_with_pen_and_bell_notification_checklist_form_report_checkbox_business_3d_background_illustration_1-removebg-preview.png" alt="note" />
        </div>
        <form className="w-full flex flex-col gap-8 justify-end text-secondary-300">
          <div className="w-full flex flex-col gap-2">
            <input
              ...
              placeholder="0912*******"
            />
            <span className="text-xs w-full h-auto flex px-4 text-secondary-400">
              * شماره مبایل الزامی میباشد.
            </span>
          </div>
          <div className="w-full flex flex-col gap-2 text-xs ">
            <p>
              ورود و ثبت نام در تایم فلو به منزله پذیزش{" "}
              <span className="text-blue-500">قوانین و مقررات</span> است.
            </p>
            <button className="btn-full">تایید شماره</button>
          </div>
        </form>
        <div className="w-full flex justify-center items-center gap-1 mt-10">
          <span className="bg-secondary-400 w-2 h-2 rounded-full"></span>
