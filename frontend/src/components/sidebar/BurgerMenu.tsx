...
function BurgerMenu({ isOpen, setIsOpen }: BurgerMenuProps) {
  return (
    <>
      <div
        className={`calc-width h-[100vh] bg-primary-950 flex flex-col shadow-sm shadow-black sidebar fixed top-0 -right-[100vw] overflow-scroll  ${
      ...
      >
        ...
        <div className="overflow-auto">
          ...
          <div className="w-full mt-10 h-auto px-8 py-4">
      ...
      <div
        className={`w-[100px] h-auto min-h-[100vh] bg-primary-900 opacity-30 absolute top-0 sidebar ${
